...
class FormAlumno(QtWidgets.QWidget):
    ...
    def set_msj_save_alumno(self,msj):
        if msj == '':
           ...
           self.combo_box_socio.setCurrentText('')
           self.ui.comboBoxGrado.setCurrentText('')
           self.ui.comboBoxDivision.setCurrentText('')
           self.ui.comboBoxTurno.setCurrentText('')
    ...
    def clean_data_alumno(self):
        ...
        self.ui.lineEditNombreAlumno.setText('')
        self.combo_box_socio.setCurrentText('')
        self.ui.comboBoxGrado.setText('')
        self.ui.comboBoxDivision.setText('')
        self.ui.comboBoxTurno.setText('')
