...
class MainWindow(QtWidgets.QWidget):
    ...
    def onSearchConsultaSocio(self, search_str: str, check_socio: bool ):
        ...
        self.__table_model_socio = SociosTableModel()
        self.cleanLayout(self.ui.layoutFormSocio)
        self.__table_socio.set_socios_table_model_search(self.__table_model_socio, search_str, check_socio)
        self.ui.layoutFormSocio.addWidget(self.__table_socio)
        self.setFixedWidth(1000)
    ...
    def onSearchConsultaAlumno(self, search_str: str, check_alumno: bool):
        ...
        self.__table_model_alumno = AlumnosTableModel()
        self.cleanLayout(self.ui.layoutFormSocio)
        self.__table_alumno.set_alumnos_table_model_search(self.__table_model_alumno, search_str, check_alumno)
        self.ui.layoutFormSocio.addWidget(self.__table_alumno)
        self.setFixedWidth(1000)
...
class TableAlumno(QtWidgets.QWidget):
    ...
    def setup(self):
        ...
        self.main_window.set_icon_button(self.ui.updateButton,'../assets/icons/feather/edit.svg')
        self.main_window.set_icon_button(self.ui.inactiveButton,'../assets/icons/feather/slash.svg')
    ...
    def set_alumnos_table_model_search(self, model: QAbstractTableModel, search_str: str, check_alumno: bool):
        self.ui.tableView.setModel(model)
        self.ui.tableView.setColumnWidth(0, 250)
        ...
        self.main_window.set_change_button_text_icon(check_alumno, self.ui.inactiveButton)

    def __on_enter_pressed_alumno(self):
        self.main_window.onSearchConsultaAlumno(self.ui.lineEdit.text(), self.ui.checkBox.isChecked())
...
class TableSocio(QtWidgets.QWidget):
    ...
    def set_socios_table_model_search(self, model: QAbstractTableModel, search_str: str, check_socio: bool ):
        self.ui.tableView.setModel(model)
        self.ui.tableView.setColumnWidth(0, 250)
        ...
        self.ui.lineEdit.installEventFilter(self)
        self.ui.checkBox.installEventFilter(self)
        self.main_window.set_change_button_text_icon(check_socio, self.ui.inactiveButton)

    def __on_enter_pressed_socio(self):
        self.main_window.onSearchConsultaSocio(self.ui.lineEdit.text(), self.ui.checkBox.isChecked())
...
class AlumnoUpdateWindow(QtWidgets.QWidget):
    ...
    def set_filter_socio_model(self, model: ListSocioModel, combo_box_socio: ExtendedComboBox):
    ...
    def setup(self):
        ...
        self.main_window.set_icon_button(self.ui.saveAlumno ,'../assets/icons/feather/save.svg')
        self.main_window.set_icon_button(self.ui.pushButton,'../assets/icons/feather/x.svg')
...
class SocioUpdateWindow(QtWidgets.QWidget):
    ...
    def setup(self):
        ...
        self.main_window.set_icon_button(self.ui.saveSocio, '../assets/icons/feather/save.svg')
        self.main_window.set_icon_button(self.ui.botonSalir, '../assets/icons/feather/x.svg')
